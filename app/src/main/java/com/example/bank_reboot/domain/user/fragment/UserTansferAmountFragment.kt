 ...
 * Use the [UserTansferAmountFragment.newInstance] factory method to
...
class UserTansferAmountFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment UserTansferAmountFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            UserTansferAmountFragment().apply {
