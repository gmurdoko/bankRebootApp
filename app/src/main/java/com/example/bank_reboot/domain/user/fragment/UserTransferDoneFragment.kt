 ...
 * Use the [UserTransferDoneFragment.newInstance] factory method to
...
class UserTransferDoneFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment UserTransferDoneFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            UserTransferDoneFragment().apply {
